 ...
 */
const massMessagesEmail = async (recipient, subject, htmlMessage, attachments = []) => {
  try {
    const transporter = nodemailer.createTransport({
      ...
      secure: false,
      auth: {
        user: 'massnotification.tradehunters@gmail.com',
        pass: 'mqaf xoej vmci uule',
      },
...
module.exports = massMessagesEmail;